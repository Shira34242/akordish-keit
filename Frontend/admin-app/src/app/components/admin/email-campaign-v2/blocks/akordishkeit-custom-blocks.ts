  ...
  {% for i in (0..max_idx) %}
    ...
    <td width="50%" valign="top" class="akd-article-cell" style="padding:{{ gap | divided_by: 2 }}px;direction:rtl;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" dir="rtl" style="background-color:#000000;border-radius:{{ radius }}px;overflow:hidden;">
        <tr><td colspan="2" height="128" style="height:128px;padding:0;line-height:0;background-color:#000000;">
        ...
        <tr>
          <td height="42" valign="middle" style="height:42px;padding:5px 10px 5px 8px;background-color:#000000;text-align:right;direction:rtl;vertical-align:middle;"><a href="{{ item.publicUrl | escape }}" target="_blank" style="display:block;height:32px;overflow:hidden;color:#ffffff;text-decoration:none;font-family:Arial,sans-serif;font-size:{{ title_font_size }}px;font-weight:800;line-height:{{ title_line_height }}px;">{{ item.title | truncate: 68 | escape }}</a></td>
          <td width="32" height="42" valign="middle" style="width:32px;height:42px;padding:5px 0 5px 10px;background-color:#000000;text-align:left;vertical-align:middle;"><a href="{{ item.publicUrl | escape }}" target="_blank" style="display:inline-block;width:32px;height:32px;line-height:32px;border-radius:9px;background-color:#ddff53;color:#000000;text-align:center;text-decoration:none;font-family:Arial,sans-serif;font-size:20px;font-weight:800;">&#8249;</a></td>
        </tr>
      </table>
    </td>
