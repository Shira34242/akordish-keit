...
export class ArtistDetailComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  getSocialIconSvg(platform: SocialPlatform): SafeHtml {
    ...
    const icons: { [key: number]: string } = {
      ...
      [SocialPlatform.AppleMusic]: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><rect x="3" y="3" width="18" height="18" rx="4.5"/><path d="M15.8 7.2v8.1"/><path d="M15.8 7.2 9.4 8.7v8.1"/><ellipse cx="7.9" cy="17.1" rx="2.1" ry="1.6" fill="currentColor" stroke="none"/><ellipse cx="14.3" cy="15.6" rx="2.1" ry="1.6" fill="currentColor" stroke="none"/></svg>`,
